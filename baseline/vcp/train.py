...
# Define parameters
DATASET = args['dataset']  # polyvore
NB_EPOCH = args['epochs']  # 4000
DO = args['dropout']  # 0.5
HIDDEN = args['hidden']   # [350,350,350]
LR = args['learning_rate']  # 0.001
WRITESUMMARY = args['write_summary']  # false
SUMMARIESDIR = args['summaries_dir']  # logs/
FEATURES = "img"
NUMCLASSES = 2
DEGREE = args['degree']  # 1
BATCH_NORM = args['batch_norm']
BN_AS_TRAIN = False
SUP_DO = args['support_dropout'] # 0.15
...
if DATASET in ['fashiongen', 'polyvore']:
    ...
    # 生成训练集的特征矩阵，邻接矩阵，训练groundture以及行和列的索引
